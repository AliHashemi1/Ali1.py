created by SAYED ALI ABBAS HASHEMI
#!/usr/bin/python3
#---------------------[IMPORT]---------------------#
...
prox = []
try:prox= requests.get('https://raw.githubusercontent.com/BestProfessionals/Professionals/main/.prox.txt').text
    open('.prox.txt','w').write(prox)
except Exception as e:
    print(' WELCOME TO RANDOM CLONING SYSTEM')
...
logo =                                          ("""   
 ...
 ##  ##   ##  ##   ##  ##   ##  ##   ##       ##   ##    ##    
 ##  ##   ##  ##    ####    ##  ##   ######   ##   ##   ####   
                                                          CREATED BY\33[0;m     \033[1;31m𝐍𝐆𝑇_𝐶𝐻𝐴𝑁𝑁𝐸𝐿\33[0;m\033[1;39m Pro \033[1;35mTeam\33[0;m
\033[1;32m               \033[1;32mAUTHOR       :  \033[1;32mHashemi
\033[1;32m               \033[1;36mGITHUB       :  \033[1;33mSayed Ali Abbas Hashemi
...
clear()
os.system("xdg-open https://www.facebook.com/Sayed Ali Abbas Hashemi")
xxxx = str(len(ugen))
...
def main():
    ...
    print(f"\033[1;97m[02] \033[1;92mJOIN TO 𝐍𝐆𝑇_𝐶𝐻𝐴𝑁𝑁𝐸𝐿")
    print(f"\033[1;97m[03] \033[1;92mJOIN TO 𝐍𝐆𝑇_𝐶𝐻𝐴𝑁𝑁𝐸𝐿")
    print(f"\033[1;97m[00] \033[1;92mEXIT ")
    print('\033[1;32m--------------------------------------------------------------') 
    ali = input("\033[1;37m[\033[1;31m!\033[1;37m]\033[1;32m SELECT \033[1;37m: \033[1;36m")
    if ali in ["1","01"]:
        passx()
    elif ali in ["2","02"]:
        os.system("xdg-open https://t.me/𝐍𝐆𝑇_𝐶𝐻𝐴𝑁𝑁𝐸𝐿")
        main()
    elif ali in ["3","03"]:
        os.system("xdg-open https://t.me/𝐍𝐆𝑇_𝐶𝐻𝐴𝑁𝑁𝐸𝐿")
        main()
...
def passx():
    ...
    print('\033[1;32m--------------------------------------------------------------') 
    ali= input("\033[1;37m[\033[1;32m!\033[1;37m]\033[1;37m SELECT METHOD \033[1;37m: \033[1;36m")
if ali in ["1","01"]:
        ali1()
    elif ali in ["2","02"]:
        ali2()
